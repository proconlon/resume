...
\section{Education}
  \resumeSubHeadingListStart
    \resumeEducationSubheading
      ...
      {B.S. in Computer Engineering}{Boston, MA}
      {Minor in Computer Science}

    \item[]
      \small \textbf{Relevant Coursework (GPA: 3.47)}: \\
      \small Distributed Systems (Go), Embedded Systems, Operating Systems, Cybersecurity, Client-Server Software
...
%             \begin{itemize}[itemsep=-5pt, leftmargin=0.15in, parsep=3pt]
%                 \item\small Cybersecurity
%                 \item Operating Systems
%                 \item Distributed Systems
%                 \item Applied Algorithms
%                 \item Embedded Systems
%                 \item Computer Networking
%                 \item Client-Server~Software
%                 \item Software~Design~(C\#/.NET)
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {ei$^3$ : Industrial Internet Intelligence}{Jun 2024 -- Present}
    {Embedded Software and Security Intern}{Pearl River, NY}
    \resumeItemListStart

        \resumeItem{Developed a multi-instance OpenVPN solution in Docker (Python, Java, Bash), enabling advanced network routing (fwmark, policy routing, NAT) to secure legacy industrial devices in production.}
    ...
    \resumeSubheading
      {BU Information Services and Technology}{Aug 2022 -- Dec 2024}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\textbf{FPGA-Based \underline{\href{https://github.com/proconlon/fpga-synth}{Keyboard Synthesizer}}} $|$ \emph{Verilog, FPGA, Digital Signal Processing, Team Project}}{Dec 2023}
        \resumeItemListStart
    ...
    \resumeProjectHeading
          {\textbf{Android App: \underline{\href{https://github.com/proconlon/BostonWhereAreU}{Boston Where Are U}}} $|$ \emph{Android SDK, Java, Team Project}}{Dec 2023}       
          \resumeItemListStart
            ...
            \resumeItem{Implemented key features including custom overlays, TouchImageView map integration, and backend game management with Android navigation components for fragment management.}
          \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Java, Python, Go, C (systems-level), Bash, Verilog} \\
     %\textbf{Framework}{: Spring Boot, React} \\
     \textbf{Networking and Security}{: Docker, OpenVPN, NAT/VLAN/Routing, PKI/Certificate Management, Wireshark} \\
     \textbf{Tools and Platforms}{: Linux (Debian), Docker Compose, Android SDK, Kali Linux (for security labs/CTFs), Git} \\
     %\textbf{Other Skills}{: Virtualization, Containerization, Network Troubleshooting} \\
    }}
 \end{itemize}
 \vspace{-16pt}
